                    ...
                    <el-form ref="addTopForm" :model="addTopForm" label-width="100px">
                        <div class="accountMessage">
                            ...
                            <el-form-item label="角色：" prop="role">
                                <el-select v-model="addTopForm.role" size="mini" placeholder="请选择"
                                           @focus="loadRoleList">
                                    <el-option :label="item.label" :value="item.value"
                                               v-for="(item,index) in roleList" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                        ...
                        <div class="accountMessage">
                            ...
                            <el-form-item label="业务身份：" prop="channel">
                                <el-select v-model="addTopForm.channel" placeholder="请选择" size="mini">
                                    <el-option :label="item.label" :value="item.value"
                                               v-for="(item,index) in channelList" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                            ...
                            <el-form-item label="归属地区：" class="homeLocation">
                                <el-select v-model="addTopForm.province" placeholder="请选择省份" size="mini"
                                    ...
                                    <el-option :label="item.label" :value="item.value"
                                               v-for="(item,index) in options.province" :key="index"></el-option>
                                </el-select>
                                <el-select v-model="addTopForm.city" placeholder="请选择市" size="mini" @change="loadArea">
                                    <el-option :label="item.label" :value="item.value"
                                               v-for="(item,index) in options.city" :key="index"></el-option>
                                </el-select>
                                <el-select v-model="addTopForm.district" placeholder="请选择区/镇/县" size="mini">
                                    <el-option :label="item.label" :value="item.value"
                                               v-for="(item,index) in options.area" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
