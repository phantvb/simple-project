    ...
    <div>
                ...
                <div class="card">
                    <section>
                        ...
                        <div class="part center picture">
                            ...
                            <el-button type="primary" size="mini" class="button"><i class="el-icon-plus">&nbsp;新增企业</i>
                            </el-button>
                        </div>
                ...
                <div class="card">
                    <section>
                        ...
                        <div class="part center picture">
                            ...
                            <el-button type="primary" size="mini" class="button"><i class="el-icon-plus">&nbsp;新增预受理</i>
                            </el-button>
                        </div>
        ...
        <div style="width: 30%; float: right; overflow:auto;  height:832px;">
            <el-card class="right_card">
                ...
                <div v-for="item in systemNotice.tableData" class="noticeItem">
                    <div style="float: left;">
                        <div class="radio"></div>
                    </div>
                    <div class="text" style="float: left;">
                        ...
                        <div class="content grey">{{item.content}}</div>
