    ...
    <div style="margin-top: 15px;">
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="自助直销" name="3">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in bTotalCount1" :key="o" :offset="1" style="margin-top: 10px;">
                    ...
                    <el-form label-width="100px">
                      ...
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          ...
                          <el-button type="text" class="button" :style="'display:'+bTableData1[index].type+';'"
                                     @click="deleteInfo(bTableData1[index].id,'delValueAdded')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
        ...
        <el-collapse-item title="渠道" name="4">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in bTotalCount2" :key="o" :offset="1" style="margin-top: 10px;">
                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                    ...
                    <el-form label-width="100px">
                      ...
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          ...
                          <el-button type="text" class="button" :style="'display:'+bTableData2[index].type+';'"
                                     @click="deleteInfo(bTableData2[index].id,'delValueAdded')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      updateTariff(num, index) {
        ...
        this.AddComboForm.unit = this.tableData[num][index].units;
