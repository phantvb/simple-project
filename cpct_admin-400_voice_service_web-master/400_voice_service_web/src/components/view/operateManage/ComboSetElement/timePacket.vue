    ...
    <div style="margin-top: 15px;">
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="自助直销" name="7">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in dTotalCount1" :key="o" :offset="1" style="margin-top: 10px;">
                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                  <div class="add-title">{{dTableData1[index].timePacketName}}</div>
                  <div class="add-body">
                    <el-form label-width="100px">
                      <el-form-item label="充值额度：" class="add-item">{{dTableData1[index].rechargeLimit}}元
                      </el-form-item>
                      <el-form-item label="拨打时长：" class="add-item">{{dTableData1[index].dialingTime}}分钟
                      </el-form-item>
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          <el-button type="text" class="button" @click="updateTimePacket(0,index)">编辑</el-button>
                          <el-button type="text" class="button"
                                     @click="deleteInfo(dTableData1[index].id,'delTimePacket')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
        ...
        <el-collapse-item title="渠道" name="8">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in dTotalCount2" :key="o" :offset="1" style="margin-top: 10px;">
                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                  <div class="add-title">{{dTableData2[index].timePacketName}}</div>
                  <div class="add-body">
                    <el-form label-width="100px">
                      <el-form-item label="充值额度：" class="add-item">{{dTableData2[index].rechargeLimit}}元
                      </el-form-item>
                      <el-form-item label="拨打时长：" class="add-item">{{dTableData2[index].dialingTime}}分钟
                      </el-form-item>
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          <el-button type="text" class="button" @click="updateTimePacket(1,index)">编辑</el-button>
                          <el-button type="text" class="button"
                                     @click="deleteInfo(dTableData2[index].id,'delTimePacket')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
