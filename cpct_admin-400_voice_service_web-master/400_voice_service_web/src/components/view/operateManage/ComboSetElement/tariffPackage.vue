        ...
        <div style="margin-top: 15px;">
            <el-collapse v-model="activeNames" @change="handleChange">
                <el-collapse-item title="自助直销" name="1">
                    <div>
                        <el-row>
                            <el-col :span="4" v-for="(o, index) in aTotalCount1" :key="o" :offset="1"
                                    style="margin-top: 10px;">
                                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                                    <div class="add-title">{{aTableData1[index].tariffName}}</div>
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item label="类型：" class="add-item">
                                                {{aTableData1[index].type}}
                                            </el-form-item>
                                            <el-form-item label="套餐规则：" class="add-item">
                                                {{aTableData1[index].packageRules}}
                                            </el-form-item>
                                            <el-form-item label="基本功能费：" class="add-item">
                                                {{aTableData1[index].basicFunctionFee}}元
                                            </el-form-item>
                                            <el-form-item label="套餐内单价：" class="add-item">
                                                {{aTableData1[index].unitPrice}}元/分钟
                                            </el-form-item>
                                            <el-form-item label="赠送时长：" class="add-item">
                                                {{aTableData1[index].durationPresentation}}分钟
                                            </el-form-item>
                                            <el-form-item label="超出资费：" class="add-item">
                                                {{aTableData1[index].excessTariff}}元/分钟
                                            </el-form-item>
                                            <el-form-item label="套餐内容：" class="add-item">
                                                <el-popover
                                                    ...
                                                    width="200"
                                                    trigger="click"
                                                    :content=aTableData1[index].packageContent>
                                            ...
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    ...
                                                    <el-button type="text" class="button"
                                                               @click="deleteInfo(aTableData1[index].id,'delTariff')">删除
                                                    </el-button>
                                                </div>
                                            </div>
                ...
                <el-collapse-item title="渠道" name="2">
                    <div>
                        <el-row>
                            <el-col :span="4" v-for="(o, index) in aTotalCount2" :key="o" :offset="1"
                                    style="margin-top: 10px;">
                                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                                    <div class="add-title">{{aTableData2[index].tariffName}}</div>
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item label="类型：" class="add-item">{{aTableData2[index].type}}
                                            </el-form-item>
                                            <el-form-item label="套餐规则：" class="add-item">
                                                {{aTableData2[index].packageRules}}
                                            </el-form-item>
                                            <el-form-item label="基本功能费：" class="add-item">
                                                {{aTableData2[index].basicFunctionFee}}元
                                            </el-form-item>
                                            <el-form-item label="套餐内单价：" class="add-item">
                                                {{aTableData2[index].unitPrice}}元/分钟
                                            </el-form-item>
                                            <el-form-item label="赠送时长：" class="add-item">
                                                {{aTableData2[index].durationPresentation}}分钟
                                            </el-form-item>
                                            <el-form-item label="超出资费：" class="add-item">
                                                {{aTableData2[index].excessTariff}}元/分钟
                                            </el-form-item>
                                            <el-form-item label="套餐内容：" class="add-item">
                                                <el-popover
                                                    placement="bottom"
                                                    width="200"
                                                    trigger="click"
                                                    :content=aTableData2[index].packageContent>
                                                    <el-button slot="reference" type="text" class="button">查看详情
                                                    </el-button>
                                                </el-popover>
                                            </el-form-item>
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    ...
                                                    <el-button type="text" class="button"
                                                               @click="deleteInfo(aTableData2[index].id,'delTariff')">删除
                                                    </el-button>
                                                </div>
                                            </div>
                ...
                <div>
                    <el-form ref="addFeesForm" :model="addFeesForm" label-width="100px">
                        ...
                        <el-form-item label="套餐内容：">
                            <el-input type="textarea" :rows="5" v-model="addFeesForm.packageContent"
    ...
    export default {
        ...
        methods: {
            ...
            addFees() {
                ...
                if (this.addFeesForm.checkList.length == 1 && this.addFeesForm.checkList[0] == "自助直销") {
                    str = "self";
                }
                if (this.addFeesForm.checkList.length == 1 && this.addFeesForm.checkList[0] == "渠道") {
                    str = "channel";
                }
                this.$ajax.post('/vos/tariffPackage/addTariff', {
                    "tariff": {
                        ...
                        "bottomFee": '',
                        "durationPresentation": this.addFeesForm.durationPresentation,
            ...
            updateFees() {
                ...
                this.$ajax.post('/vos/tariffPackage/updateTariff', {
                    "tariff": {
