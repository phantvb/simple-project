        ...
        <div style="margin-top: 15px;">
            <el-collapse v-model="activeNames" @change="handleChange">
                <el-collapse-item title="自助直销" name="5">
                    <div>
                        <el-row>
                            <el-col :span="4" v-for="(o, index) in cTotalCount1" :key="o" :offset="1"
                                    style="margin-top: 10px;">
                                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                                    <div class="add-title">{{cTableData1[index].concessionName}}</div>
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item label="优惠方式：" class="add-item">
                                                {{cTableData1[index].concessionWay}}
                                            </el-form-item>
                                            <el-form-item label="充值额度：" class="add-item">
                                                {{cTableData1[index].rechargeLimit}}元
                                            </el-form-item>
                                            <el-form-item label="赠送额度：" class="add-item">
                                                {{cTableData1[index].donationQuota}}元
                                            </el-form-item>
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    <el-button type="text" class="button"
                                                               @click="updateDiscount(0,index)">编辑
                                                    </el-button>
                                                    <el-button type="text" class="button"
                ...
                <el-collapse-item title="渠道" name="6">
                    <div>
                        <el-row>
                            <el-col :span="4" v-for="(o, index) in cTotalCount2" :key="o" :offset="1"
                                    style="margin-top: 10px;">
                                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                                    ...
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item label="优惠方式：" class="add-item">
                                                {{cTableData2[index].concessionWay}}
                                            </el-form-item>
                                            <el-form-item label="充值额度：" class="add-item">
                                                {{cTableData2[index].rechargeLimit}}元
                                            </el-form-item>
                                            <el-form-item label="赠送额度：" class="add-item">
                                                {{cTableData2[index].donationQuota}}元
                                            </el-form-item>
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    <el-button type="text" class="button"
                                                               @click="updateDiscount(1,index)">编辑
                                                    </el-button>
                                                    <el-button type="text" class="button"
