    ...
    <div style="margin-top: 15px;">
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="自助直销" name="5">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in cTotalCount1" :key="o" :offset="1" style="margin-top: 10px;">
                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                  <div class="add-title">{{cTableData1[index].concessionName}}</div>
                  <div class="add-body">
                    <el-form label-width="100px">
                      <el-form-item label="优惠方式：" class="add-item">{{cTableData1[index].concessionWay}}
                      </el-form-item>
                      <el-form-item label="充值额度：" class="add-item">{{cTableData1[index].rechargeLimit}}元
                      </el-form-item>
                      <el-form-item label="赠送额度：" class="add-item">{{cTableData1[index].donationQuota}}元
                      </el-form-item>
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          <el-button type="text" class="button" @click="updateDiscount(0,index)">编辑</el-button>
                          <el-button type="text" class="button"
                                     @click="deleteInfo(cTableData1[index].id,'delConcessionScheme')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
        ...
        <el-collapse-item title="渠道" name="6">
          <div>
            <el-row>
              <el-col :span="4" v-for="(o, index) in cTotalCount2" :key="o" :offset="1" style="margin-top: 10px;">
                <el-card :body-style="{ padding: '0px'}" shadow="hover">
                  <div class="add-title">{{cTableData2[index].concessionName}}</div>
                  <div class="add-body">
                    <el-form label-width="100px">
                      <el-form-item label="优惠方式：" class="add-item">{{cTableData2[index].concessionWay}}
                      </el-form-item>
                      <el-form-item label="充值额度：" class="add-item">{{cTableData2[index].rechargeLimit}}元
                      </el-form-item>
                      <el-form-item label="赠送额度：" class="add-item">{{cTableData2[index].donationQuota}}元
                      </el-form-item>
                      <div style="border-top: 1px solid #f5f5f5;">
                        <div style="float: right;">
                          <el-button type="text" class="button" @click="updateDiscount(1,index)">编辑</el-button>
                          <el-button type="text" class="button"
                                     @click="deleteInfo(cTableData2[index].id,'delConcessionScheme')">删除
                          </el-button>
                        </div>
                      </div>
                    </el-form>
    ...
    <div class="addDiscountDialog">
      <el-dialog
        ...
        <div>
          <el-form ref="addDiscountForm" :model="addDiscountForm" label-width="100px">
            ...
            <el-form-item label="优惠方案：">
              <el-select v-model="addDiscountForm.value" placeholder="请选择" style="float: left;width: 80%" size="mini"
                         @change="changeStyle">
                <el-option
            ...
            <el-form-item label="套餐优惠：" :style="'display:'+addDiscountForm.style2+';'">
              <el-input v-model="addDiscountForm.packageDeals" size="mini" class="el-input"></el-input>
              <span class="span">元</span>
            </el-form-item>

            <el-form-item label="可用时长：" :style="'display:'+addDiscountForm.style2+';'">
            ...
            <el-form-item label="优惠时间：" :style="'display:'+addDiscountForm.style2+';'">
              <el-input v-model="addDiscountForm.concessionTime" size="mini" class="el-input"
                        style="width: 40%;"></el-input>
              <el-select v-model="addDiscountForm.value2" placeholder="请选择"
                         style="float: left; margin-left: 10%; width: 30%;" size="mini">
                <el-option
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="handleUpdateDiscount" size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      addDiscount() {
        ...
        if (this.addDiscountForm.checkList.length == 1 && this.addDiscountForm.checkList[0] == "自助直销") {
          channel = "self";
        }
        if (this.addDiscountForm.checkList.length == 1 && this.addDiscountForm.checkList[0] == "渠道") {
          channel = "channel";
        }

        if (this.addDiscountForm.value2 == '1') {
          units = 'month';
        }
        if (this.addDiscountForm.value2 == '2') {
          units = 'year';
        }
          this.$ajax.post('/vos/tariffPackage/addConcessionScheme', {
          "concessionScheme": {
      ...
      updateDiscount(num, index) {
        ...
        let units = '';
        if (this.tableData[num][index].units == 'month') {
          units = '1';
        }
        if (this.tableData[num][index].units == 'year') {
          units = '2';
        }
      ...
      handleUpdateDiscount() {
        ...
        if (this.addDiscountForm.checkList.length == 1 && this.addDiscountForm.checkList[0] == "渠道") {
          ...
          this.$ajax.post('/vos/tariffPackage/updateConcessionScheme', {
          "concessionScheme": {
