                ...
                <div>
                    <el-form-item label="选择角色：">
                        ...
                        <el-button
                            ...
                            :key="index"
                            @click="searchMess(allRoleTableData[index].name)"
                        >{{allRoleTableData[index].nameZh}}</el-button>
                    </el-form-item>
                </div>
            </el-form>
        </div>
                    ...
                    <el-form ref="addTopForm" :model="addTopForm" label-width="100px">
                        ...
                        <div class="accountMessage">
                            ...
                            <el-form-item label="归属地区：" class="homeLocation">
                                ...
                                <el-select
                                    v-model="addTopForm.district"
                                    placeholder="请选择区/镇/县"
                                    size="mini"
                                >
                                    <el-option
                                        :label="item.label"
            ...
            >
                <el-form ref="addTopForm" :model="addTopForm" label-width="100px">
                    ...
                    <div class="accountMessage">
                        ...
                        <el-form-item
                            label="归属地区："
                        >{{detailsDialogForm.province}}{{detailsDialogForm.city}}{{detailsDialogForm.area}}</el-form-item>
