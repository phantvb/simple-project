                                    ...
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item
                                                label="类型："
                                                class="add-item"
                                            >{{aTableData1[index].type}}</el-form-item>
                                            <el-form-item
                                                label="套餐规则："
                                                class="add-item"
                                            >{{aTableData1[index].packageRules}}</el-form-item>
                                            <el-form-item
                                                label="基本功能费："
                                                class="add-item"
                                            >{{aTableData1[index].basicFunctionFee}}元</el-form-item>
                                            <el-form-item
                                                label="套餐内单价："
                                                class="add-item"
                                            >{{aTableData1[index].unitPrice}}元/分钟</el-form-item>
                                            <el-form-item
                                                label="赠送时长："
                                                class="add-item"
                                            >{{aTableData1[index].durationPresentation}}分钟</el-form-item>
                                            <el-form-item
                                                label="超出资费："
                                                class="add-item"
                                            >{{aTableData1[index].excessTariff}}元/分钟</el-form-item>
                                            ...
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    <el-button
                                                        type="text"
                                                        class="button"
                                                        @click="updateTariff(0,index)"
                                                    >编辑</el-button>
                                                    <el-button
                                                        type="text"
                                                        class="button"
                                                        @click="deleteInfo(aTableData1[index].id,'delTariff')"
                                                    >删除</el-button>
                                                </div>
                                            </div>
                                        </el-form>
                                    ...
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item
                                                label="类型："
                                                class="add-item"
                                            >{{aTableData2[index].type}}</el-form-item>
                                            <el-form-item
                                                label="套餐规则："
                                                class="add-item"
                                            >{{aTableData2[index].packageRules}}</el-form-item>
                                            <el-form-item
                                                label="基本功能费："
                                                class="add-item"
                                            >{{aTableData2[index].basicFunctionFee}}元</el-form-item>
                                            <el-form-item
                                                label="套餐内单价："
                                                class="add-item"
                                            >{{aTableData2[index].unitPrice}}元/分钟</el-form-item>
                                            <el-form-item
                                                label="赠送时长："
                                                class="add-item"
                                            >{{aTableData2[index].durationPresentation}}分钟</el-form-item>
                                            <el-form-item
                                                label="超出资费："
                                                class="add-item"
                                            >{{aTableData2[index].excessTariff}}元/分钟</el-form-item>
                                            <el-form-item label="套餐内容：" class="add-item">
                                                <el-popover
                                                    placement="bottom"
                                                    width="200"
                                            ...
                                            <div style="border-top: 1px solid #f5f5f5;">
                                                <div style="float: right;">
                                                    <el-button
                                                        type="text"
                                                        class="button"
                                                        @click="updateTariff(1,index)"
                                                    >编辑</el-button>
                                                    <el-button
                                                        type="text"
                                                        class="button"
                                                        @click="deleteInfo(aTableData2[index].id,'delTariff')"
                                                    >删除</el-button>
                                                </div>
                                            </div>
                                        </el-form>
                ...
                <div>
                    <el-form ref="addFeesForm" :model="addFeesForm" label-width="100px">
                        ...
                        <el-form-item label="套餐规则：">
                            <el-input
                                v-model="addFeesForm.packageRules"
                                size="mini"
                                class="el-input"
                            ></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="基本功能费：">
                            <el-input
                                v-model="addFeesForm.basicFunctionFee"
                                size="mini"
                                class="el-input"
                            ></el-input>
                        ...
                        <el-form-item label="赠送时长：">
                            <el-input
                                v-model="addFeesForm.durationPresentation"
                                size="mini"
                                class="el-input"
                            ></el-input>
                        ...
                        <el-form-item label="超出资费：">
                            <el-input
                                v-model="addFeesForm.excessTariff"
                                size="mini"
                                class="el-input"
                            ></el-input>
                            <span class="span">元/分钟</span>
                        ...
                        <el-form-item label="套餐内容：">
                            <el-input
                                type="textarea"
                                :rows="5"
                                v-model="addFeesForm.packageContent"
                                class="el-input"
                            ></el-input>
                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        updateTariff(num, index) {
            ...
            this.addFeesForm.packageRules = this.tableData[num][
                index
            ].packageRules;
            this.addFeesForm.basicFunctionFee = this.tableData[num][
                index
            ].basicFunctionFee;
            this.addFeesForm.units = this.tableData[num][index].units;
            this.addFeesForm.unitPrice = this.tableData[num][index].unitPrice;
            this.addFeesForm.durationPresentation = this.tableData[num][
                index
            ].durationPresentation;
            this.addFeesForm.excessTariff = this.tableData[num][
                index
            ].excessTariff;
            this.addFeesForm.packageContent = this.tableData[num][
                index
            ].packageContent;
