                                    ...
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item
                                                label="功能资费："
                                                class="add-item"
                                            >{{bTableData1[index].tariffFee}}元{{bTableData1[index].units}}</el-form-item>
                                            <el-form-item
                                                label="是否赠送："
                                                class="add-item"
                                            >{{bTableData1[index].presents}}</el-form-item>
                                    ...
                                    <div class="add-body">
                                        <el-form label-width="100px">
                                            <el-form-item
                                                label="功能资费："
                                                class="add-item"
                                            >{{bTableData2[index].tariffFee}}元{{bTableData2[index].units}}</el-form-item>
                                            <el-form-item
                                                label="是否赠送："
                                                class="add-item"
                                            >{{bTableData2[index].presents}}</el-form-item>
                                            <el-form-item label="功能备注：" class="add-item">
                                                <el-popover
                                                    placement="bottom"
                                                    width="200"
