		...
		methods: {
			...
			getIdsFunction() {
				...
				for (let i = 0; i < this.addNumberForm.selfCheckList.length; i++) {
					for (
						let j = 0; j < this.addNumberForm.selfTableData.length; j++
					) {
						if (
				...
				for (
					let i = 0; i < this.addNumberForm.channelCheckList.length; i++
				) {
					for (
						let j = 0; j < this.addNumberForm.channelTableData.length; j++
					) {
						if (
