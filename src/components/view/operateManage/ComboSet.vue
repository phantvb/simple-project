<template>
	<div id="ComboSet">
		...
		<div style="position: relative;margin-top: 20px">
			<el-tabs v-model="active" type="card">
				...
				<el-tab-pane label="增值业务" name="2">
					<div>
						<el-button type="primary" style="float: left;" @click="showAddCombo"><i class="el-icon-plus">&nbsp;新增增值服务套餐</i></el-button>
					</div>
					<div style="clear: both;"></div>
					<div style="margin-top: 15px;">
						<el-collapse v-model="activeNames" @change="handleChange">
												...
												<div class="add-body">
													<el-form label-width="100px">
														...
														<el-form-item label="功能备注：" class="add-item">
															<el-popover placement="bottom" width="200" trigger="click" content="">
																<el-button slot="reference" type="text" class="button">查看详情</el-button>
															</el-popover>
														</el-form-item>
														<div style="border-top: 1px solid #f5f5f5;">
				...
				<el-tab-pane label="优惠方案" name="3">
					<div>
						<el-button type="primary" style="float: left;" @click="showAddDiscount"><i class="el-icon-plus">&nbsp;新增优惠方案</i></el-button>
					</div>
					<div style="clear: both;"></div>
					<div style="margin-top: 15px;">
						<el-collapse v-model="activeNames" @change="handleChange">
		...
		<div class="addFeesDialog">
			<el-dialog title="新增资费套餐" :visible.sync="addFeesFromDialogVisible" width="30%" :before-close="handleClose">
				<div>
					...
					<el-form ref="addDiscountForm" :model="addDiscountForm" label-width="100px">
						<el-form-item label="优惠方案：">
							<el-select v-model="addDiscountForm.value" placeholder="请选择" style="float: left;width: 80%">
								<el-option v-for="item in addDiscountForm.options" :key="item.value" :label="item.label" :value="item.value">
								</el-option>
							</el-select>
						</el-form-item>
		...
		<div class="addTimePacketDialog">
			<el-dialog title="新增时长包方案" :visible.sync="addTimePacketFormDialogVisible" width="30%" :before-close="handleClose">
				<div>
