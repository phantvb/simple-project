	...
	<div id="billManage" class="managerFormTitle">
		<el-tabs v-model="active">
			...
			<el-table v-show="billType==0" :data="tableData" style="width: 100%;margin-bottom:15px;">
				...
				<el-table-column prop="type" label="月份" min-width="80">
				</el-table-column>
				<el-table-column prop="name" label="企业名称" min-width="100">
				</el-table-column>
				<el-table-column prop="number" label="400号码" min-width="100">
				</el-table-column>
				<el-table-column prop="person" label="套餐" min-width="80">
				</el-table-column>
				<el-table-column prop="date" label="套餐内计费" min-width="120">
				</el-table-column>
				<el-table-column prop="status" label="超额计费" min-width="120">
				</el-table-column>
				<el-table-column prop="status" label="时长包计费" min-width="120">
				</el-table-column>
				<el-table-column prop="status" label="增值业务费用" min-width="150">
				</el-table-column>
				<el-table-column prop="status" label="费用合计" min-width="80">
				</el-table-column>
			...
			<el-table v-show="billType==1" :data="tableData" style="width: 100%;margin-bottom:15px;">
				...
				<el-table-column prop="name" label="总时长（秒）" min-width="100">
				</el-table-column>
				<el-table-column prop="number" label="总分钟数" min-width="100">
				</el-table-column>
				<el-table-column prop="date" label="套餐内计费" min-width="120">
				</el-table-column>
				<el-table-column prop="status" label="超额计费" min-width="100">
				</el-table-column>
				<el-table-column prop="status" label="时长包计费" min-width="120">
				</el-table-column>
				<el-table-column prop="status" label="费用合计" min-width="100">
				</el-table-column>
				<el-table-column prop="status" label="线路成本" min-width="100">
				</el-table-column>
			</el-table>
