	...
	<div id="billDetail" class="lightblueTable">
		<el-dialog title="号码月账单详情" class="left" :visible.sync="dialogVisible" @close="close" v-if="dialogVisible">
			...
			<div class="block">
				<ul>
					<li class="l2">
						...
						<p class="fmini">企业名称: 15622771295</p>
					</li>
					<li class="l2">
						<p class="fmini">引示号: 057186694234</p>
						<p class="fmini">账单月份: 2018-10</p>
					</li>
				</ul>
			</div>
			...
			<div class="block">
				<ul>
					<li class="l2">
						<p class="fmini">基本套餐: 400商务热线3000套餐</p>
						<p class="fmini">套餐金额: 3000 元</p>
						<p class="fmini">套餐内时长（剩余/总量）：0/30000 分钟</p>
					</li>
					<li class="l2">
						<p class="fmini">套餐期限: 1 年</p>
						<p class="fmini">套餐内计费：3000 元</p>
						<p class="fmini">套餐剩余金额: 0 元</p>
					</li>
				</ul>
			</div>
			...
			<div class="block">
				...
				<ul>
					<li class="l2">
						<p class="fmini">时长包剩余时长: 0 分钟</p>
					</li>
					<li class="l2">
						<p class="fmini">时长包计费: 55100 元</p>
					</li>
				</ul>
			</div>
			...
			<div class="block">
				<ul>
					<li class="l2">
						<p class="fmini">超额时长：2109 分钟</p>
					</li>
					<li class="l2">
						<p class="fmini">超额计费：210 元</p>
					</li>
				</ul>
			</div>
			<div class="title">增值业务</div>
			<div class="block">
				<el-table :data="firmData" border style="width: 100%" :header-row-class-name="'lightblue'">
