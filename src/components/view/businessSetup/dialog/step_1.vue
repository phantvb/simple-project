		...
		<el-form ref="form" :model="form" label-width="80px" :rules="rules">
			...
			<div class="block">
				<el-form-item label="企业名称" prop="companyName">
					<el-input v-model="form.companyName" size="small" placeholder="营业执照上公司全称，个体工商户填写字号全称，组织机构上的机构全称"></el-input>
				</el-form-item>
				<el-form-item label="证件编号" prop="companyCardType">
					<el-select v-model="form.companyCardType" placeholder="请选择" size="small">
						<el-option v-for="item in companyCardOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
					</el-select>
					<el-input v-model="form.companyCardNo" size="small" placeholder=" 根据证件类型，填写相应的证件号码"></el-input>
				</el-form-item>
				<ul>
					<li class="l3">
					...
					<li class="l3">
						<el-form-item label="行业类型" prop="industryType">
							<el-select v-model="form.industryType" placeholder="请选择" size="small">
				...
				<el-form-item label="注册地址" prop="registAddress">
					<ul>
						<li class="l3">
							<el-select v-model="form.registProvince" filterable placeholder="请选择省份" size="small" @change="clear('regist',0)">
								<el-option v-for="item in ProvinceOptions" :key="item.id" :label="item.province" :value="item.province"></el-option>
							</el-select>
						</li>
						<li class="l3">
							<el-select v-model="form.registCity" filterable placeholder="请选择城市" size="small" @focus="getCity" @change="clear('regist',1)">
								<el-option v-for="item in registCityOptions" :key="item.id" :label="item.city" :value="item.city"></el-option>
							</el-select>
						</li>
						<li class="l3">
							<el-select v-model="form.registArea" filterable placeholder="请选择区" size="small" @focus="getArea">
								<el-option v-for="item in registAreaOptions" :key="item.id" :label="item.area" :value="item.area"></el-option>
							</el-select>
						</li>
					</ul>
					<el-input v-model="form.registAddress" size="small" placeholder="填入企业营业执照上的详细地址"></el-input>
				</el-form-item>
				<el-form-item label="办公地址" prop="officeAddress">
					<ul>
						<li class="l3">
							<el-select v-model="form.officeProvince" filterable placeholder="请选择省份" size="small" @change="clear('office',0)">
								<el-option v-for="item in ProvinceOptions" :key="item.id" :label="item.province" :value="item.province"></el-option>
							</el-select>
						</li>
						<li class="l3">
							<el-select v-model="form.officeCity" filterable placeholder="请选择城市" size="small" @focus="getOfficeCity" @change="clear('office',1)">
								<el-option v-for="item in officeCityOptions" :key="item.id" :label="item.city" :value="item.city"></el-option>
							</el-select>
						</li>
						<li class="l3">
							<el-select v-model="form.officeArea" filterable placeholder="请选择区" size="small" @focus="getOfficeArea">
								<el-option v-for="item in officeAreaOptions" :key="item.id" :label="item.area" :value="item.area"></el-option>
							</el-select>
						</li>
					</ul>
					<el-input v-model="form.officeAddress" size="small" placeholder="填入企业办公所在地址"></el-input>
				</el-form-item>
				<el-form-item label="企业电话" prop="phone">
					<el-input v-model="form.phone" size="small" placeholder="填入企业联系电话（固话或手机）"></el-input>
				</el-form-item>
			</div>
			<div class="title">
				法人基本信息
			...
			<div class="block">
				<ul>
					<li>
						<el-form-item label="法人姓名" prop="legalPerson">
							<el-input v-model="form.legalPerson" size="small" placeholder="填入法人真实姓名"></el-input>
						</el-form-item>
					</li>
					<li>
						<el-form-item label="法人电话" prop="legalPhone">
							<el-input v-model="form.legalPhone" size="small" placeholder="填入法人联系电话（固话或手机）"></el-input>
						</el-form-item>
					</li>
				</ul>
				<el-form-item label="法人证件" prop="legalCard">
					<ul>
						<li class="l3">
							<el-select v-model="form.legalCard" placeholder="请选择" size="small">
								<el-option v-for="item in legalCardOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
							</el-select>
						</li>
						<li style="width:66%;">
							<el-input v-model="form.cardNum" size="small" placeholder="根据证件类型，填写相应的证件号码"></el-input>
						</li>
					</ul>
				</el-form-item>
				<el-form-item label="身份证住址" v-if="form.legalCard=='id_card'" prop="idCardAddress">
					<el-input v-model="form.idCardAddress" size="small" placeholder="填入身份证上的住址"></el-input>
				</el-form-item>
				<el-form-item label="身份证有效期" v-if="form.legalCard=='id_card'" prop="cardDate">
					<el-date-picker v-model="form.cardDate" size="small" placeholder="选择身份证起止日期" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"></el-date-picker>
				</el-form-item>
			</div>
		</el-form>
		<footer class="right">
