				...
				<div class="legalInfo">
					...
					<el-form-item label="法人证件：" class="legalCard" prop="legalCard">
						<el-select v-model="acceptForm.legalCard" @change="change123" placeholder="请选择" size="mini" :disabled="msgDisabled">
							<el-option v-for="item in legalCardTypeList" :label="item.dicValue" :value="item.dicKey" :key="item.dicValue"></el-option>
						</el-select>
						<el-input v-model="acceptForm.cardNum" size="mini" placeholder="根据证件类型，填写相应的证件号码" prop="cardNum" :disabled="msgDisabled"></el-input>
					</el-form-item>
					...
					<el-form-item label="身份证有效期：" class="indate" v-if="acceptForm.legalCard=='ID_card'" prop="idIndate">
						<el-date-picker v-model="acceptForm.idIndate" type="daterange" :disabled="msgDisabled" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="护照有效期：" class="indate" v-if="acceptForm.legalCard=='Passport'" prop="idIndate">
						<el-date-picker v-model="acceptForm.idIndate" :disabled="msgDisabled" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
						</el-date-picker>
					</el-form-item>
