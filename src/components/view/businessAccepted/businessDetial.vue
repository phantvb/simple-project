<template>
	<div id="businessDetial">
		...
		<div id="progress">
			...
			<el-input v-model="desc" v-if="($route.query.status=='审核中'||$route.query.status=='变更审核中'||$route.query.status=='注销审核')&&baseData.roleName=='ROLE_admin'" type="textarea" :rows="6" placeholder="请输入审核意见">
